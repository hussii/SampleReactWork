...
export const MOVE_DOCUMENTS = "MOVE_DOCUMENTS";
export const MOVE_DOCUMENTS_SUCCESS = "MOVE_DOCUMENTS_SUCCESS";
export const MOVE_DOCUMENTS_FAILURE = "MOVE_DOCUMENTS_FAILURE";
export const DUPLICATE_DOCUMENTS = "DUPLICATE_DOCUMENTS";
export const DUPLICATE_DOCUMENTS_SUCCESS = "DUPLICATE_DOCUMENTS_SUCCESS";
export const DUPLICATE_DOCUMENTS_FAILURE = "DUPLICATE_DOCUMENTS_FAILURE";
export const EDIT_FOLDER_NAME = "EDIT_FOLDER_NAME";
export const EDIT_FOLDER_NAME_SUCCESS = "EDIT_FOLDER_NAME_SUCCESS";
export const EDIT_FOLDER_NAME_FAILURE = "EDIT_FOLDER_NAME_FAILURE";
...
export const ADD_NEW_FOLDER_FAILURE = "ADD_NEW_FOLDER_FAILURE";
export const SET_SELECTED_DOCUMENT = "SET_SELECTED_DOCUMENT";

// Document Viewer
export const GET_VIEWING_DOCUMENT = "GET_VIEWING_DOCUMENT";
export const GET_VIEWING_DOCUMENT_SUCCESS = "GET_VIEWING_DOCUMENT_SUCCESS";
export const GET_VIEWING_DOCUMENT_FAILURE = "GET_VIEWING_DOCUMENT_FAILURE";

export const CREATE_COMPOSITE_WORKFLOW = "CREATE_COMPOSITE_WORKFLOW";
export const CREATE_COMPOSITE_WORKFLOW_SUCCESS = "CREATE_COMPOSITE_WORKFLOW_SUCCESS";
export const CREATE_COMPOSITE_WORKFLOW_FAILURE = "CREATE_COMPOSITE_WORKFLOW_FAILURE";

//Corporate
export const GET_COMPANIES = "GET_COMPANIES";
export const GET_COMPANIES_SUCCESS = "GET_COMPANIES_SUCCESS";
export const GET_COMPANIES_FAILURE = "GET_COMPANIES_FAILURE";
export const GET_COMPANYUSERS = "GET_COMPANYUSERS";
export const GET_COMPANYUSERS_SUCCESS = "GET_COMPANYUSERS_SUCCESS";
export const GET_COMPANYUSERS_FAILURE = "GET_COMPANYUSERS_FAILURE";
export const GET_CONTACTSASUSERS = "GET_CONTACTSASUSERS";
export const GET_CONTACTSASUSERS_SUCCESS = "GET_CONTACTSASUSERS_SUCCESS";
export const GET_CONTACTSASUSERS_FAILURE = "GET_CONTACTSASUSERS_FAILURE";

// Contacts
export const GET_CONTACTS = "GET_CONTACTS";
export const GET_CONTACTS_SUCCESS = "GET_CONTACTS_SUCCESS";
export const GET_CONTACTS_FAILURE = "GET_CONTACTS_FAILURE";
export const SORT_CONTACTS_BY_NAME = "SORT_CONTACTS_BY_NAME";
export const SORT_CONTACTS_BY_EMAIL = "SORT_CONTACTS_BY_EMAIL";
